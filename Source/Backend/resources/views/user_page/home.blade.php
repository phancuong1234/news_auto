  ...
  <div class="main__content col-xl-8 border-right" id="main-content">
    <div class="row mb-4">
        <div class="content__card col-xl-7">
          <a href="{{route('detail', [$main_new->slug_cate, $main_new->slug])}}"><img class="image__sidebar img-fluid img-news-home-big" src="{{ (strpos($main_new->image, config('setting.type_img.img_of_serve')) === 0)?asset('images/news/'.$main_new->image):$main_new->image }}" alt="image-1"></a>
          ...
          <ul class="list-unstyled">
            <li class="media">
              <a href="{{route('detail', [$key->slug_cate, $key->slug])}}" class="img-news-home">
                <img class="mr-3" src="{{ (strpos($key->image, config('setting.type_img.img_of_serve')) === 0)?asset('images/news/'.$key->image):$key->image }}" alt="image-2">
              </a>
            ...
            <div class="row">
              <div class="category__content col-xl-7">
                ...
                <div class="media d-flex flex-column flex-sm-row mb-2">
                  <a href="{{ route('detail', [$value[0]['slug_cate'], $value[0]['slug']]) }}" class="img-news-home-md"><img class="mr-3 w100" src="{{ (strpos($value[0]['image'], config('setting.type_img.img_of_serve')) === 0)?asset('images/news/'.$value[0]['image']):$value[0]['image'] }}" alt="images/image-cagetory1"></a>
              ...
              <div class="col-xl-5">
                <ul class="list-unstyled">
                  <li class="media">
                    <a href="{{route('detail', [$value[1]['slug_cate'], $value[1]['slug']])}}" class="img-news-home"><img class="mr-3" src="{{ (strpos($value[1]['image'], config('setting.type_img.img_of_serve')) === 0)?asset('images/news/'.$value[1]['image']):$value[1]['image'] }}" alt="image-cagetory2"></a>
                    <div class="media-body">
                ...
                <ul class="list-unstyled">
                  <li class="media">
                    <a href="{{route('detail', [$value[2]['slug_cate'], $value[2]['slug']])}}" class="img-news-home"><img class="mr-3" src="{{ (strpos($value[2]['image'], config('setting.type_img.img_of_serve')) === 0)?asset('images/news/'.$value[2]['image']):$value[2]['image'] }}" alt="image-cagetory3"></a>
                    <div class="media-body">
